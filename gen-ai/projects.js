/* GENERATIVE AI PROJECTS
   To add a project, copy an object below, update its fields and place its image
   inside the main /assets folder. Numbers are generated automatically. */
window.AI_PROJECTS = [
  {
    title: "@unemployedkittens",
    type: "Generative AI · Social storytelling · Ongoing",
    description: "A playful generative-AI social page following kittens with too much personality and no conventional career prospects—an experiment in recurring characters, visual comedy and compact storytelling. More than 1,000,000 views & 1,000 followers on Instagram.",
